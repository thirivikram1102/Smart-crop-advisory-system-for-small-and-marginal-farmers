      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Tamil Voice Assistant Button (Prominent) */}
            <button
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 p-1 sm:px-2.5 sm:py-1 rounded-lg bg-emerald-800 hover:bg-emerald-700 text-white text-xs font-medium transition-colors"
              >
                ...
                <span className="hidden sm:inline truncate max-w-[100px]">
                  {farmer?.name?.split(' ')[0] || 'Ravi'}
                </span>
                <ChevronDown className="w-3.5 h-3.5 text-emerald-300" />
              </button>

              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white text-stone-900 rounded-xl shadow-xl border border-stone-200 z-50 overflow-hidden py-1">
                  <div className="px-3 py-2 border-b border-stone-100 bg-stone-50">
                    <p className="text-xs font-bold text-stone-900">{farmer?.name}</p>
                    ...
                    <span className="inline-block mt-1 text-[10px] bg-emerald-100 text-emerald-800 font-semibold px-2 py-0.5 rounded">
                      {farmer?.farmSizeAcres} Acres • {farmer?.mainCrops[0] || 'Paddy'}
                    </span>
                  </div>
                  <button
                    onClick={() => {
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 py-2 text-xs text-emerald-700 font-semibold hover:bg-emerald-50 flex items-center gap-2"
                  >
